...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, tech.jhipster.sample.domain.UserEntity.class.getName());
            createCache(cm, tech.jhipster.sample.domain.Authority.class.getName());
            createCache(cm, tech.jhipster.sample.domain.UserEntity.class.getName() + ".authorities");
            createCache(cm, tech.jhipster.sample.domain.ProjectEntity.class.getName());
