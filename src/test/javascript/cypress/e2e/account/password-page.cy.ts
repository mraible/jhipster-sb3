...
describe('/account/password', () => {
  ...
  // TODO v8 reenable, depends on https://github.com/jhipster/generator-jhipster/issues/19991
  it.skip('should fail to update password when using incorrect current password', () => {
